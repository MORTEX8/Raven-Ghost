...
public class Raven {
    ...
    public static final String sourceLocation = "https://github.com/MORTEX8/Raven-Ghost";
    public static final String downloadLocation = "https://github.com/MORTEX8/Raven-Ghost/tree/stable/build/libs";
    public static final String discord = "https://discord.gg/MysuH9V6fT";
    public static String[] updateText = {
            "Your version of Raven B-ND (" + versionManager.getClientVersion().toString() + ") is outdated!",
